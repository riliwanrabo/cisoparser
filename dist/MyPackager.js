...
let fld127 = [
    ...
    new IFA_LLCHAR(25, "TERMINAL OWNER"),
...
class MyPacker_127 extends ISOBasePackager {
    constructor() {
        super();
        this.setFieldPackager(fld127);
    }
}
exports.MyPacker_127 = MyPacker_127;
const p127 = new MyPacker_127;
let fld = [
    ...
    new IFA_LLLCHAR(999, "RESERVED PRIVATE USE"),
    new IFA_LLLCHAR(999, "RESERVED PRIVATE USE"),
    new ISOMsgFieldPackager(new IFA_LLLLLLBINARY(99999, "RESERVED PRIVATE USE"), p127),

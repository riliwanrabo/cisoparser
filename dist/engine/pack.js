...
import * as concon from "./dataelement-config.json" assert { type: "json" };
("use strict");
// Object.defineProperty(exports, "__esModule", { value: true });
class Pack {
  constructor(dataElements, config = null) {
    this.dataElements = dataElements;
    const defaultConfig = concon;
    if (config !== null) {
      this.config = config;
    } else {
  ...
  setElement(field, fieldData) {
    ...
    fieldData =
      fieldConfig.fixedLength === true ? fieldData : variableLength + fieldData;
